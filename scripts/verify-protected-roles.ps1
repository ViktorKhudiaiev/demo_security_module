...
SELECT json_build_object(
 ...
 'roles',json_build_object(
  ...
  'audit_can_enqueue_notification',has_table_privilege('audit_processor','notification_outbox','INSERT'),
  'audit_can_mark_notification_delivery',has_column_privilege('audit_processor','notification_outbox','delivered_at_micros','UPDATE'),
  'audit_cannot_rewrite_notification_reason',NOT has_column_privilege('audit_processor','notification_outbox','reason','UPDATE'),
  'audit_cannot_delete_notification',NOT has_table_privilege('audit_processor','notification_outbox','DELETE'),
  'key_cannot_enqueue_notification',NOT has_table_privilege('audit_key','notification_outbox','INSERT'),
  'accounting_cannot_enqueue_notification',NOT has_table_privilege('settlement_processor','notification_outbox','INSERT'),
