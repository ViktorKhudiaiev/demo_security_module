...
export const flowSteps = [
 {title:'Request an authorized transfer',from:'user',to:'app',label:'1 · Transfer request',path:'M125 145 H190',text:'Module 1 owns business authorization. The security module protects the boundary against a Primary DB attacker; it does not replace application authorization.'},
 ...
 {title:'Record verification evidence',from:'processor',to:'audit',label:'9 · VERIFIED audit event',path:'M420 370 H805 V405 H845',text:'A VERIFIED event records what was checked. Its presence alone is not execution permission. Receipt, audit and accounting are separate table groups and runtime roles in the same protected PostgreSQL database.'},
