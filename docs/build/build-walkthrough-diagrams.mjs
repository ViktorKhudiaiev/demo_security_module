...
export function architectureSvg(){return `<svg viewBox="0 0 1180 595" role="img" aria-labelledby="architecture-title"><title id="architecture-title">Three modules, two PostgreSQL databases and ActiveMQ embedded inside Module 3</title><defs><marker id="flow-arrow" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto"><path d="M0 0 L10 5 L0 10 Z" fill="#215acc"/></marker></defs>
...
${text(25,575,'Only Primary DB is in attacker scope. The processor host, key service and protected database remain trusted.','sub')}</svg>`;}
