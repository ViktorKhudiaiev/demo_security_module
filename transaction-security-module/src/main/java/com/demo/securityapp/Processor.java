...
public class Processor {
    ...
    private final Map<UUID,Fault> faults=new ConcurrentHashMap<>();
    ...
    public void reconcile() {
        ...
        KeyGateway.Inventory page=keys.inventory(inventoryCursor);
        for(KeyGateway.InventoryItem item:page.items()) {
    ...
    public void configureFault(Fault fault) {
    ...
    public record Fault(UUID operationId,long pauseAfterVerifyMillis,boolean failAfterDebit){}
